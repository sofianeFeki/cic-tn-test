...
const Sale = () => {
  return (
    <div className="py-20 flex flex-col md:flex-row items-center justify-between gap-4 lg:gap-10">
      <div className="bg-[#f3f3f3] w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center items-center text-black  drop-shadow-xl overflow-x-hidden group cursor-pointer">
      ...
      <div className="w-full md:w-2/3 lg:w-1/2 h-auto flex flex-col gap-4 lg:gap-10">
        <div className="h-1/2 w-full  drop-shadow-xl overflow-x-hidden group cursor-pointer">
          <Link to="/shop">
